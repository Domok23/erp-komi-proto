        ...
        return $table->columns([
            ...
            ->actions([
                ActionGroup::make([
                    EditAction::make(),
                    DeleteAction::make()
                        ->before(function (Subcon $record, DeleteAction $action) {
                ...
                BulkActionGroup::make([
                    DeleteBulkAction::make()
                        ->before(function (Collection $records, DeleteBulkAction $action) {
                            ...
                            if (! empty($blocked)) {
                                Notification::make()
                                    ->title('Cannot Delete Selected Subcontractors')
                                    ->body('Some subcontractors cannot be deleted: '.implode('; ', $blocked).'.')
                                    ->danger()
                                    ->persistent()
                                    ->send();
